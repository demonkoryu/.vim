...
hi htmlBold			guifg=#ccccaf gui=bold
hi htmlItalic			guifg=#ffffaf gui=italic
hi htmlUnderline		guifg=#ffffaf gui=underline
hi htmlBoldItalic		guifg=#ccccaf gui=bold,italic
hi htmlBoldUnderline		guifg=#ccccaf gui=bold,underline
hi htmlBoldUnderlineItalic	guifg=#ccccaf gui=bold,underline,italic
hi htmlUnderlineItalic		guifg=#ffffaf gui=underline,italic
