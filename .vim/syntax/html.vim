...
" Netscape extensions
syn keyword htmlTagName contained frame noframes frameset
"nobr blink
...
if !exists("html_no_rendering")
  " rendering
  syn cluster htmlTop contains=@Spell,htmlTag,htmlEndTag,htmlSpecialChar,htmlPreProc,htmlComment,htmlLink,javaScriptAn,javaScript,@htmlPreproc,cssStyleAn
  ...
  syn region htmlLink start="<a\>\_[^>]*\<href\>" end="</a>"me=e-4 contains=@Spell,htmlTag,htmlEndTag,htmlSpecialChar,htmlPreProc,htmlComment,javaScriptAn,javaScript,@htmlPreproc
  ...
  syn region htmlHead start="<head\>" end="</head>"me=e-7 end="<body\>"me=e-5 end="<h[1-6]\>"me=e-3 contains=htmlTag,htmlEndTag,htmlSpecialChar,htmlPreProc,htmlComment,htmlLink,htmlTitle,javaScriptAn,javaScript,cssStyleAn,cssStyle,@htmlPreproc
  syn region htmlTitle start="<title\>" end="</title>"me=e-8 contains=htmlTag,htmlEndTag,htmlSpecialChar,htmlPreProc,htmlComment,javaScriptAn,javaScript,@htmlPreproc
endif
...
if main_syntax != 'java' || exists("java_javascript")
  ...
  " New region for annotated java script
  syn region  javaScriptAn start=+//JS\++ keepend end=+//JS-+ contains=@htmlJavaScript,htmlCssStyleComment,htmlScriptTag,@htmlPreproc
  "" XXX CSS
  syn region  cssStyleAn start=+/\*CSS\++me=s+2 keepend end=+/\*CSS-\*/+ contains=@htmlCss,htmlCssStyleComment,@htmlPreproc
  " XXX CSS
...
if main_syntax != 'java' || exists("java_css")
  ...
  unlet b:current_syntax
  syn region cssStyle start=+<style+ keepend end=+</style>+ contains=@htmlCss,htmlTag,htmlEndTag,@htmlPreproc
