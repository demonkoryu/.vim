...
syn keyword psqlStatement alter analyze audit comment commit create delete drop execute explain grant insert lock rename revoke rollback savepoint select set truncate update analyze vacuum replace
" added by thermo
syn keyword psqlKeyword cascade restrict no action before after each statement execute procedure returns sql plpgsql strict immutable stable volatile called input external security invoker definer new old owned none

syn keyword psqlType	boolean char character date float integer long mlslabel number raw rowid varchar varchar2 varray int int4 int8 float4 float8 line interval lseq smallint bigint serial bigserial inet cidr macaddr bit varbit bool box bytea circle numeric decimal path point polygon text time timetz timestamp timestamptz real name int2vector regproc oid tid xid cid oidvector smgr lseg double abstime reltime tinterval aclitem void opaque refcursor regprocedure regoper regoperator regclass regtype record cstring anyarray array language_handler constant
...
syn keyword psqlFunction abbrev abs abstime abstimeeq abstimege abstimegt abstimele abstimelt abstimene aclcontains aclinsert aclremove acos age alt_to_iso alt_to_koi8r alt_to_mic alt_to_utf8 alt_to_win1251 area areajoinsel areasel array_dims array_eq array_length_coerce ascii ascii_to_mic ascii_to_utf8 asin atan2 atan big5_to_euc_tw big5_to_mic big5_to_utf8 bitand bitcat bitcmp bit biteq bitge bitgt bitle bit_length bitlt bitne bitnot bitor bitshiftleft bitshiftright bitxor booleq boolge boolgt boolle boollt boolne box_above box_add box_below box_center box_contained box_contain box_distance box_div box box_eq box_ge box_gt box_intersect box_le box_left box_lt box_mul box_overlap box_overleft box_overright box_right box_same box_sub bpcharcmp bpchar bpchareq bpcharge bpchargt bpcharle bpcharlt bpcharne broadcast btabstimecmp btbeginscan btboolcmp btbuild btbulkdelete btcharcmp btcostestimate btendscan btfloat4cmp btfloat8cmp btgettuple btinsert btint2cmp btint4cmp btint8cmp btmarkpos btnamecmp btoidcmp btoidvectorcmp btrescan btrestrpos btrim bttextcmp byteacat byteacmp byteaeq byteage byteagt byteale bytealike bytealt byteane byteanlike cash_div_flt4 cash_div_flt8 cash_div_int2 cash_div_int4 cash_eq cash_ge cash_gt cashlarger cash_le cash_lt cash_mi cash_mul_flt4 cash_mul_flt8 cash_mul_int2 cash_mul_int4 cash_ne cash_pl cashsmaller cash_words cbrt ceil center character_length chardiv char chareq charge chargt charle char_length charlt charmi charmul charne charpl chr cideq cidr circle_above circle_add_pt circle_below circle_center circle_contained circle_contain circle_contain_pt circle_distance circle_div_pt circle circle_eq circle_ge circle_gt circle_le circle_left circle_lt circle_mul_pt circle_ne circle_overlap circle_overleft circle_overright circle_right circle_same circle_sub_pt close_lb close_lseg close_ls close_pb close_pl close_ps close_sb close_sl col_description contjoinsel contsel convert convert_using cos cot current_database current_schema current_schemas current_setting current_user currtid2 currtid currval date_cmp date date_eq date_ge date_gt date_larger date_le date_lt date_mi date_mii date_mi_interval date_ne date_part date_pli date_pl_interval date_smaller datetime_pl datetimetz_pl date_trunc dcbrt decode degrees dexp diagonal diameter dist_cpoly dist_lb dist_pb dist_pc dist_pl dist_ppath dist_ps dist_sb dist_sl dlog10 dlog1 dpow dround dsqrt dtrunc encode eqjoinsel eqsel euc_cn_to_mic euc_cn_to_utf8 euc_jp_to_mic euc_jp_to_sjis euc_jp_to_utf8 euc_kr_to_mic euc_kr_to_utf8 euc_tw_to_big5 euc_tw_to_mic euc_tw_to_utf8 exp factorial float48div float48eq float48ge float48gt float48le float48lt float48mi float48mul float48ne float48pl float4abs float4_accum float4div float4 float4eq float4ge float4gt float4larger float4le float4lt float4mi float4mul float4ne float4pl float4smaller float4um float4up float84div float84eq float84ge float84gt float84le float84lt float84mi float84mul float84ne float84pl float8abs float8_accum float8_avg float8div float8 float8eq float8ge float8gt float8larger float8le float8lt float8mi float8mul float8ne float8pl float8smaller float8_stddev float8um float8up float8_variance floor flt4_mul_cash flt8_mul_cash fmgr_c_validator fmgr_internal_validator fmgr_sql_validator format_type gb18030_to_utf8 gbk_to_utf8 get_bit get_byte getdatabaseencoding getpgusername gistbeginscan gistbuild gistbulkdelete gistcostestimate gistendscan gistgettuple gistinsert gistmarkpos gistrescan gistrestrpos has_database_privilege has_function_privilege hashbeginscan hashbpchar hashbuild hashbulkdelete hashchar hashcostestimate hashendscan hashfloat4 hashfloat8 hashgettuple hashinsert hashint2 hashint4 hashint8 hashmacaddr hashmarkpos hashname hashoid hashoidvector hashrescan hashrestrpos hashvarlena has_language_privilege has_schema_privilege has_table_privilege height host iclikejoinsel iclikesel icnlikejoinsel icnlikesel icregexeqjoinsel icregexeqsel icregexnejoinsel icregexnesel inet initcap int24div int24eq int24ge int24gt int24le int24lt int24mi int24mod int24mul int24ne int24pl int28eq int28ge int28gt int28le int28lt int28ne int2abs int2_accum int2and int2_avg_accum int2div int2 int2eq int2fac int2ge int2gt int2larger int2le int2lt int2mi int2mod int2_mul_cash int2mul int2ne int2not int2or int2pl int2shl int2shr int2smaller int2_sum int2um int2up int2vectoreq int2xor int42div int42eq int42ge int42gt int42le int42lt int42mi int42mod int42mul int42ne int42pl int48div int48eq int48ge int48gt int48le int48lt int48mi int48mul int48ne int48pl int4abs int4_accum int4and int4_avg_accum int4div int4 int4eq int4fac int4ge int4gt int4inc int4larger int4le int4lt int4mi int4mod int4_mul_cash int4mul int4ne int4not int4notin int4or int4pl int4shl int4shr int4smaller int4_sum int4um int4up int4xor int82eq int82ge int82gt int82le int82lt int82ne int84div int84eq int84ge int84gt int84le int84lt int84mi int84mul int84ne int84pl int8abs int8_accum int8and int8_avg int8div int8 int8eq int8fac int8ge int8gt int8inc int8larger int8le int8lt int8mi int8mod int8mul int8ne int8not int8or int8pl int8shl int8shr int8smaller int8_sum int8um int8up int8xor inter_lb inter_sb inter_sl interval_accum interval_avg interval_cmp interval_div interval interval_eq interval_ge interval_gt interval_hash interval_larger interval_le interval_lt interval_mi interval_mi_time interval_mi_timetz interval_mul interval_ne interval_pl interval_pl_time interval_smaller interval_um intinterval isclosed isfalse isfinite ishorizontal isnotfalse isnottrue iso8859_1_to_utf8 iso8859_to_utf8 isopen iso_to_alt iso_to_koi8r iso_to_mic iso_to_win1251 isparallel isperp istrue isvertical johab_to_utf8 koi8r_to_alt koi8r_to_iso koi8r_to_mic koi8r_to_utf8 koi8r_to_win1251 latin1_to_mic latin2_to_mic latin2_to_win1250 latin3_to_mic latin4_to_mic length like like_escape likejoinsel likesel line_distance line line_eq line_horizontal line_interpt line_intersect line_parallel line_perp line_vertical ln lo_close lo_creat lo_export log lo_import lo_lseek lo_open loread lo_tell lo_unlink lower lowrite lpad lseg_center lseg_distance lseg lseg_eq lseg_ge lseg_gt lseg_horizontal lseg_interpt lseg_intersect lseg_le lseg_length lseg_lt lseg_ne lseg_parallel lseg_perp lseg_vertical ltrim macaddr_cmp macaddr macaddr_eq macaddr_ge macaddr_gt macaddr_le macaddr_lt macaddr_ne masklen mic_to_alt mic_to_ascii mic_to_big5 mic_to_euc_cn mic_to_euc_jp mic_to_euc_kr mic_to_euc_tw mic_to_iso mic_to_koi8r mic_to_latin1 mic_to_latin2 mic_to_latin3 mic_to_latin4 mic_to_sjis mic_to_win1250 mic_to_win1251 mktinterval mod mul_d_interval name nameeq namege namegt nameiclike nameicnlike nameicregexeq nameicregexne namele namelike namelt namene namenlike nameregexeq nameregexne neqjoinsel neqsel netmask network_cmp network network_eq network_ge network_gt network_le network_lt network_ne network_sub network_subeq network_sup network_supeq nextval nlikejoinsel nlikesel nonnullvalue notlike now npoints nullvalue numeric_abs numeric_accum numeric_add numeric_avg numeric_cmp numeric_div numeric numeric_eq numeric_exp numeric_ge numeric_gt numeric_inc numeric_larger numeric_le numeric_ln numeric_log numeric_lt numeric_mod numeric_mul numeric_ne numeric_power numeric_smaller numeric_sqrt numeric_stddev numeric_sub numeric_uminus numeric_uplus numeric_variance obj_description octet_length oid oideq oidge oidgt oidlarger oidle oidlt oidne oidnotin oidrand oidsmaller oidsrand oidvectoreq oidvectorge oidvectorgt oidvectorle oidvectorlt oidvectorne oidvectortypes on_pb on_pl on_ppath on_ps on_sb on_sl overlaps overlay path_add path_add_pt path_center path_contain_pt path_distance path_div_pt path path_inter path_length path_mul_pt path_n_eq path_n_ge path_n_gt path_n_le path_n_lt path_npoints path_sub_pt pclose pg_backend_pid pg_char_to_encoding pg_client_encoding pg_encoding_to_char pg_function_is_visible pg_get_constraintdef pg_get_expr pg_get_indexdef pg_get_ruledef pg_get_userbyid pg_get_viewdef pg_lock_status pg_opclass_is_visible pg_operator_is_visible pg_show_all_settings pg_stat_get_backend_activity pg_stat_get_backend_dbid pg_stat_get_backend_idset pg_stat_get_backend_pid pg_stat_get_backend_userid pg_stat_get_blocks_fetched pg_stat_get_blocks_hit pg_stat_get_db_blocks_fetched pg_stat_get_db_blocks_hit pg_stat_get_db_numbackends pg_stat_get_db_xact_commit pg_stat_get_db_xact_rollback pg_stat_get_numscans pg_stat_get_tuples_deleted pg_stat_get_tuples_fetched pg_stat_get_tuples_inserted pg_stat_get_tuples_returned pg_stat_get_tuples_updated pg_stat_reset pg_table_is_visible pg_type_is_visible pi plpgsql_call_handler point_above point_add point_below point_distance point_div point point_eq point_horiz point_left point_mul point_ne point_right point_sub point_vert poly_center poly_contained poly_contain poly_contain_pt poly_distance polygon poly_left poly_npoints poly_overlap poly_overleft poly_overright poly_right poly_same popen position positionjoinsel positionsel pow pt_contained_circle pt_contained_poly quote_ident quote_literal radians radius random regexeqjoinsel regexeqsel regexnejoinsel regexnesel reltime reltimeeq reltimege reltimegt reltimele reltimelt reltimene repeat replace RI_FKey_cascade_del RI_FKey_cascade_upd RI_FKey_check_ins RI_FKey_check_upd RI_FKey_noaction_del RI_FKey_noaction_upd RI_FKey_restrict_del RI_FKey_restrict_upd RI_FKey_setdefault_del RI_FKey_setdefault_upd RI_FKey_setnull_del RI_FKey_setnull_upd round rpad rtbeginscan rt_bigbox_size rt_box_inter rt_box_size rt_box_union rtbuild rtbulkdelete rtcostestimate rtendscan rtgettuple rtinsert rtmarkpos rt_poly_inter rt_poly_size rt_poly_union rtrescan rtrestrpos rtrim scalargtjoinsel scalargtsel scalarltjoinsel scalarltsel session_user set_bit set_byte set_config seteval set_masklen setseed setval sign similar_escape sin sjis_to_euc_jp sjis_to_mic sjis_to_utf8 slope smgreq smgrne split_part sqrt strpos substr substring tan tcvn_to_utf8 textcat text texteq text_ge text_gt texticlike texticnlike texticregexeq texticregexne text_larger text_le textlen textlike text_lt textne textnlike textregexeq textregexne text_smaller tideq time_cmp timedate_pl time time_eq time_ge time_gt time_larger time_le time_lt timemi time_mi_interval time_mi_time time_ne timenow timeofday timepl time_pl_interval time_smaller timestamp_cmp timestamp timestamp_eq timestamp_ge timestamp_gt timestamp_larger timestamp_le timestamp_lt timestamp_mi timestamp_mi_span timestamp_ne timestamp_pl_span timestamp_smaller timestamptz_cmp timestamptz timestamptz_eq timestamptz_ge timestamptz_gt timestamptz_larger timestamptz_le timestamptz_lt timestamptz_mi timestamptz_mi_span timestamptz_ne timestamptz_pl_span timestamptz_smaller timetz_cmp timetzdate_pl timetz timetz_eq timetz_ge timetz_gt timetz_hash timetz_larger timetz_le timetz_lt timetz_mi_interval timetz_ne timetz_pl_interval timetz_smaller timezone tintervalct tinterval tintervalend tintervaleq tintervalge tintervalgt tintervalle tintervalleneq tintervallenge tintervallengt tintervallenle tintervallenlt tintervallenne tintervallt tintervalne tintervalov tintervalrel tintervalsame tintervalstart to_ascii to_char to_date to_hex to_number to_timestamp translate trunc uhc_to_utf8 update_pg_pwd_and_pg_group upper userfntest utf8_to_alt utf8_to_ascii utf8_to_big5 utf8_to_euc_cn utf8_to_euc_jp utf8_to_euc_kr utf8_to_euc_tw utf8_to_gb18030 utf8_to_gbk utf8_to_iso8859_1 utf8_to_iso8859 utf8_to_johab utf8_to_koi8r utf8_to_sjis utf8_to_tcvn utf8_to_uhc utf8_to_win1251 utf_to_win1250 utf_to_win1256 utf_to_win874 varbitcmp varbit varbiteq varbitge varbitgt varbitle varbitlt varbitne varcharcmp varchar varchareq varcharge varchargt varcharle varcharlt varcharne version width win1250_to_latin2 win1250_to_mic win1250_to_utf win1251_to_alt win1251_to_iso win1251_to_koi8r win1251_to_mic win1251_to_utf8 win1256_to_utf win874_to_utf xideq
