...
syn keyword ldFunction      ABSOLUTE ADDR ALIGN BLOCK DATA_SEGMENT_ALIGN DATA_SEGMENT_END
                            \ DATA_SEGMENT_RELRO_END DEFINED LOADADDR MAX MIN NEXT SIZEOF SIZEOF_HEADERS
                            \ sizeof_headers

syn keyword ldKeyword       ENTRY INPUT GROUP OUTPUT SEARCH_DIR STARTUP OUTPUT_FORMAT TARGET
                            \ ASSERT EXTERN FORCE_COMMON_ALLOCATION INHIBIT_COMMON_ALLOCATION NOCROSSREFS
                            \ OUTPUT_ARCH PROVIDE EXCLUDE_FILE SORT KEEP FILL CREATE_OBJECT_SYMBOLS
                            \ CONSTRUCTORS SUBALIGN FILEHDR AT __asm__ ABSOLUTE

syn keyword ldDataType      BYTE SHORT LONG QUAD SQUAD
syn keyword ldOutputType    NOLOAD DSECT COPY INFO OVERLAY
syn keyword ldPTType        PT_NULL PT_LOAD PT_DYNAMIC PT_INTERP PT_NOTE PT_SHLIB PT_PHDR
