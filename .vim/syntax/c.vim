...
if !exists("c_no_c99") " ISO C99
  syn keyword	cType		_Bool bool complex
...
if !exists("c_no_ansi") || exists("c_ansi_constants") || exists("c_gnu")
  ...
  syn keyword cConstant LC_ALL LC_COLLATE LC_CTYPE LC_MONETARY LC_NUMERIC LC_TIME
  ...
  syn keyword cConstant EX_OK EX__BASE EX_USAGE EX_DATAERR EX_NOINPUT EX_NOUSER EX_NOHOST EX_UNAVAILABLE 
                      \ EX_SOFTWARE EX_OSERR EX_OSFILE EX_CANTCREAT EX_IOERR EX_TEMPFAIL EX_PROTOCOL 
                      \ EX_NOPERM EX_CONFIG EX__MAX
  " mman.h
  syn keyword cConstant MADV_NORMAL MADV_RANDOM MADV_SEQUENTIAL MADV_WILLNEED 
                      \ MADV_DONTNEED MADV_FREE MADV_NOSYNC MADV_AUTOSYNC MADV_NOCORE MADV_CORE MADV_PROTECT 
  syn keyword cConstant PROT_NONE PROT_READ PROT_WRITE PROT_EXEC 
  syn keyword cConstant MAP_ANON MAP_FIXED MAP_HASSEMAPHORE MAP_INHERIT MAP_NOCORE MAP_NOSYNC MAP_PRIVATE 
                      \ MAP_SHARED MAP_STACK MAP_FAILED
